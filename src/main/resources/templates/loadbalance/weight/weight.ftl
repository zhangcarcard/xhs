...
<head>
    ...
    <#include "/meta.ftl">
    <@common.title name="WEIGHT转发配置" />
    <#include "/head.ftl">
</head>
<body>
<#include "/fileupload.ftl">
<div class="container">
    <@common.nav menu="loadbalance" submenu="weight" />
    ...
    <div id="toolbar" class="btn-group">
        ...
        <a type="button" class="btn btn-default" href="/file/template/weight.do">
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="weight" class="form-control" id="weight" placeholder="权重为数字类型" required>
                    </div>
                    <div class="form-group">
...
<script>
    $(function() {
        createBootstrapTable('#table', '/loadbalance/weight/weight.do', ['ip', 'port', 'weight', 'protocalName', 'groupName'], ['IP', 'PORT', '权重', '协议名称', '分组名称'], true, '#toolbar', 'GET');
        createFileInput('#pupload', '/file/template/weight.do', function (event, data, previewId, index) {
        ...
        $("#btn_delete").click(function() {
            ...
            if (selections.length == 0) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "/loadbalance/weight/weight.do",
                            type: "DELETE",
        ...
        $("#form").submit(function() {
            ...
            $.post("/loadbalance/weight/weight.do", params, function(result) {
                if (result.success) {
                    toastr.success('保存成功.');
                    $('#table').bootstrapTable('refresh', {silent: true});
                    $('#addModal').modal('hide');
