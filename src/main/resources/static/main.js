(function () {
    function init(table, url, fields, titles, hasCheckbox, toolbar, method, pagination, height) {
        $(table).bootstrapTable({
            ...
            pagination: pagination == null || pagination,      //是否显示分页（*）
            ...
            height: height || 500,               //行高，如果没有设置height属性，表格自动根据记录条数决定表格高度
    ...
    // 传'#table'
    createBootstrapTable = function(table, url, fields, titles, hasCheckbox, toolbar, method, pagination, height) {
        init(table, url, fields, titles, hasCheckbox, toolbar, method, pagination, height);
    }
})();
